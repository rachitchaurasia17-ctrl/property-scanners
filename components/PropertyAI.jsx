...
- Tagline: Property Experts · Mohali
...
function PropertyAI({ onSchedule }) {
  ...
  const send = async (text) => {
    ...
    try {
      ...
      setMessages((m) => [...m, { role: "assistant", content: "I can't reach my brain right now. Please call the desk on +91 89680 17508 — they'll be happy to help." }]);
    } finally {
      setSending(false);
    }
  };
