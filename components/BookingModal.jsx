...
function BookingModal({ open, onClose }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setError("Could not reach the desk. Please call +91 89680 17508.");
    } finally {
      setSending(false);
    }
  };
    ...
    <>
      ...
      <div className={"bm-shell " + (open ? "open" : "")} role="dialog" aria-label="Schedule a viewing">
        <header className="bm-head">
          <div>
            <div className="bm-eyebrow"><span className="bm-rule"/>Sachdeva Real Estate · Reservation Desk</div>
        ...
        {sent ? (
          <div className="bm-success">
            ...
            <div className="bm-success-ref">Reference · SRE-{Math.floor(Math.random()*9000+1000)}-{(date && date.getDate()) || "00"}</div>
          ...
          <form className="bm-grid" onSubmit={submit}>
            ...
            <aside className="bm-col bm-col-summary">
              ...
              <Row k="Office"   v="ALC Market, District One · Sector 68 · Mohali" />
              ...
              <a href="tel:+918968017508" className="bm-call">Or call the desk · +91 89680 17508</a>
            </aside>
          </form>
        )}
      </div>
