    ...
    <>
      ...
      <div className={"mobile-nav " + (mobileOpen ? "open" : "")}>
        ...
        <div style={{ marginTop: 40, display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >Schedule a Viewing →</button>
          <a href="tel:+918968017508" className="uc" style={{ fontSize: 12, letterSpacing: "0.14em", color: "var(--mute)", textAlign: "center" }}>
            +91 89680 17508
          </a>
        </div>
      </div>
        ...
        <div className="hero-bottom hero-fade-late" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", borderTop: "1px solid rgba(255,255,255,0.18)", paddingTop: 22, gap: 20, flexWrap: "wrap" }}>
          <div>
            ...
            <div className="clash" style={{ fontSize: 16, letterSpacing: "-0.02em", color: "#ffffff", fontWeight: 500 }}>
              ALC Market, District One · Sector 68, Mohali
            </div>
          </div>
          <div style={{ display: "flex", gap: 18, alignItems: "center", flexWrap: "wrap" }}>
            ...
            <a href="tel:+918968017508" className="uc" style={{ fontSize: 11, letterSpacing: "0.18em", color: "rgba(255,255,255,0.72)" }}>
              +91 89680 17508
            </a>
          </div>
        </div>
      ...
      {!sent ? (
        ...
        >
          ...
          <div style={{ gridColumn: "1 / -1", display: "flex", gap: 16, alignItems: "center", marginTop: 8, flexWrap: "wrap" }}>
            ...
            <a href="tel:+918968017508" className="uc" style={{ fontSize: 12, letterSpacing: "0.14em", color: "var(--mute)" }}>
              or call +91 89680 17508
            </a>
          </div>
        </form>
      ) : (
      ...
      <div className="container">
        <header className="reviews-head">
          <div className="reviews-eyebrow">
            ...
            <span>Google · 4.9 / 5 · 87 reviews</span>
          </div>
        ...
        <div className="desk-grid">
          ...
          <div className="desk-card">
            ...
            <div className="desk-row">
              ...
              <div className="desk-row-v"><a href="tel:+918968017508">+91 89680 17508</a></div>
            </div>
            <div className="desk-row">
            ...
            <div className="desk-row">
              ...
              <div className="desk-row-v">ALC Market, District One<br/>Sector 68 · Mohali · Punjab · 160062</div>
            </div>
...
function InstagramFab() {
  ...
  return (
    <a
      href="https://www.instagram.com/thegreater.mohali/"
      target="_blank" rel="noopener noreferrer"
